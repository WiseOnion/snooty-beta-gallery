...
(function () {
  ...
  const HERO = {
    ...
    reviewCount: 87,
    years: 11,
    bio: 'Charlotte-based braider with 11 years of experience. Knotless braids, loc journeys, and tribal styles. Every client leaves feeling like themselves, just elevated.',
  ...
  const STYLISTS = [
    ...
    { id: 'camille', name: 'Camille Osei', business: 'Camille Does Hair', city: 'Charlotte, NC', avatar: AV.tasha, rating: 4.7, reviewCount: 55 },
  ...
  const FEED = [
    { img: IMG.knotlessSmall, caption: 'Small knotless, jet black, hip length', stylist: 'Jordyn Ellis', business: 'Roots & Ritual', city: 'Charlotte, NC', slug: 'knotless-braids', likes: 2800, cents: 28000, heroLook: 'lk1' },
    ...
    { img: IMG.knotlessBoho, caption: 'Boho knotless, honey blonde', stylist: 'Jordyn Ellis', business: 'Roots & Ritual', city: 'Charlotte, NC', slug: 'knotless-braids', likes: 2100, cents: 34000, heroLook: 'lk2' },
    ...
    { img: IMG.starterLocs, caption: 'Starter locs, two-strand twists', stylist: 'Jordyn Ellis', business: 'Roots & Ritual', city: 'Charlotte, NC', slug: 'locs-retwist', likes: 760, cents: 38000, heroLook: 'lk5' },
    { img: IMG.boxBurgundy, caption: 'Box braids, burgundy tips', stylist: 'Camille Osei', business: 'Camille Does Hair', city: 'Charlotte, NC', slug: 'box-braids', likes: 1200, cents: 20000 },
    ...
    { img: IMG.knotlessMedium, caption: 'Medium knotless, chocolate brown', stylist: 'Jordyn Ellis', business: 'Roots & Ritual', city: 'Charlotte, NC', slug: 'knotless-braids', likes: 1400, cents: 22000, heroLook: 'lk3' },
    ...
    { img: IMG.retwistDefined, caption: 'Fresh retwist, defined roots', stylist: 'Jordyn Ellis', business: 'Roots & Ritual', city: 'Charlotte, NC', slug: 'locs-retwist', likes: 540, cents: 9000, heroLook: 'lk6' },
